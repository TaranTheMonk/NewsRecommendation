...
def getData(user_address, docs_address):
    ...
    docs_0 = pre.corpus_docs_cn(corpus_0)
    docs_0 = pre.docs_stemmer(docs_0)
    docs_1 = pre.corpus_docs_cn(corpus_1)
    ...
    dictionary_0.filter_extremes(no_below=1, no_above=1, keep_n=None)
    dictionary_1.filter_extremes(no_below=1, no_above=1, keep_n=None)
...
address_user = '../CosSimilarity/User/cn'
address_docs = '../CosSimilarity/TestDocs/cn'
